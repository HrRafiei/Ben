...
export function CategoryList({ setSelectedItem, openEditModal, openDeleteModal }) {
    ...
    useEffect(() => {
        setLoading(true);
        const url = '/api/Admin/Category/GetAll';
    ...
    function DeleteCategory(category) {
        ...
        const url = '/api/Admin/Category/Delete/' + category.id;
        ...
        const confirmContent =
            <div>
                <Space size='small' direction='horizontal'>
                    <span>آیا می خواهید دسته بندی</span>
    ...
    const listElement = list.length > 0 ?
        <Table dataSource={list}>
            ...
            <Column title='نام دسته' dataIndex='name' key='name' />
